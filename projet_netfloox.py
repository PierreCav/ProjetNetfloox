...
df_title_rating=pd.read_csv("/Users/pierrecavallo/Downloads/title_rating.tsv", sep='\t',nrows=10000,na_values='\\N')
df_title_episode=pd.read_csv("/Users/pierrecavallo/Downloads/title_episode.tsv", sep='\t',nrows=10000,na_values='\\N')
df_title_crew=pd.read_csv("/Users/pierrecavallo/Downloads/title_crew.tsv", sep='\t',nrows=10000,na_values='\\N')
df_title_basic=pd.read_csv("/Users/pierrecavallo/Downloads/title_basic.tsv", sep='\t',nrows=10000,na_values='\\N')
df_name_basics=pd.read_csv("/Users/pierrecavallo/Downloads/name_basics.tsv", sep='\t',nrows=10000,na_values='\\N')
df_title_akas=pd.read_csv("/Users/pierrecavallo/Downloads/title_akas.tsv", sep='\t',nrows=10000,na_values='\\N')
df_title_akas.rename(columns={'titleId':'tconst'},inplace=True)
df_title_principals=pd.read_csv("/Users/pierrecavallo/Downloads/title_principals.tsv", sep='\t',nrows=10000,na_values='\\N')


con = sqlite3.connect("/Users/pierrecavallo/Desktop/Projet Netfloox/ProjetNetfloox.sqlite")
cur = con.cursor()
